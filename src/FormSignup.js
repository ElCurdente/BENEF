                ...
                {openModal &&
                    <div id="modal" className="flex w-screen h-screen bg-black bg-opacity-30 fixed bottom-0 left-0 justify-center overflow-auto z-40 items-start">
                        <div className="w-95vw xl:w-2/6 max-h-max mb-0 relative flex flex-col justify-center items-center rounded-3xl bg-white-0  dark:bg-gray-550 dark:text-white-0">
                            <div className="pt-10 flex flex-col mx-7">
                                <h1 className="text-center text-2xl font-bold">Conditions générales <br></br> & CGU </h1>
                                ...
                                <li className='mt-2 list-none'>
                                    <ul className="w-full flex justify-between items-center opacity-95 font-normal pb-10"><p>
                        ...
                        <form className="form" action="api.php" method="GET" onSubmit={handleSubmit}>
                            ...
                            <div className="flex relative justify-center items-center">
                                ...
                                <input id="birth"
                                    type="date"
                                    name="birth"
                                    className="bg-transparent border-b-2 border-red-450 w-4/5 mb-2 h-12 text-left text-gray-650 focus:outline-none pt-5 focus:placeholder-gray-650"
                            ...
                            <div className="flex justify-center relative items-center mt-8">
                                <input id="cgu"
                                    ...
                                    required
                                />
                                <label htmlFor="cgu" className="text-red-450 pl-2 cursor-pointer">Je certifie avoir pris connaissance des <span onClick={handleCGU} className="hover:underline font-semibold">CGU</span>
                                </label>
                            </div>
