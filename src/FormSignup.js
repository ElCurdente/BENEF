                ...
                <form className="form" onSubmit={handleSubmit}>
                    <div className="flex  relative justify-center items-center">
                        ...
                        <input id="username"
                            ...
                            name="username"
                            maxLength="30"
                            placeholder="Nom d'utilisateur" className="placeholder-white-150 placeholder-italic text-white-150 border-b-2 bg-transparent w-4/5 my-2 h-12 pt-5 text-left focus:outline-none  focus:placeholder-transparent"
        ...
        return (
            <div className="w-96">
                ...
                <form className="form" onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-center items-center">
                        <h3 onClick={handleConnexion} className="text-white-150 hover:underline cursor-pointer">Connecte toi</h3>
                    </div>
                </form>
            </div>
        )
