            ...
            <div className="fixed justify-center xl:-top-1 xl:h-10vh xl:w-100vw xl:justify-start bottom-0 h-7vh w-100vw bg-red-450 dark:bg-black rounded-t-lg transition duration-500">
                <nav className="w-100vw h-7vh">
                    <ul className="flex justify-around">
                        ...
                        <Link to="/post" >
                            <motion.div whileHover={{y:-10, scale: 1.1}} className="relative xl:bottom-0 xl:top-4 bottom-6 flex justify-center items-center h-16 w-16 bg-white-0 rounded-full shadow-custom">
                        ...
                        <Link to="/profil">
                        <motion.div whileHover={{ scale: 1.1}} className="relative top-3 xl:top-4 xl:mr-64">
                            <li><img className="h-25px xl:border-4 xl:h-16 xl:w-16 xl:rounded-full rounded-xl border-2 border-white" src={profil} alt=""/></li>
                            </motion.div>
                        </Link>
