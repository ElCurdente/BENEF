                    ...
                    <div className="w-full h-250px relative">
                      ...
                      <div className="bg-white-0 h-7 w-7 text-black absolute flex justify-center items-center top-3 right-2 rounded-full">
                        <button className="upvote text-red-450 dark:text-black"
                          onClick={handleFav.bind(modalItem.id_post)}>
                          {state ? state && <Lottie options={defaultOptions} height={17} width={17} /> : <img className='h-15px fill-current cursor-pointer' src={coeur} alt='' />}
                        </button>                        
                      </div>
                      
                      <div className="bg-white-0 text-black absolute top-44 text-xl font-bold flex w-max py-1 rounded-lg">
                          <button onClick={handleUpvote.bind(modalItem)} className="pl-2 relative">
                          ...
                          <span id='nb_upvote' ref={nbUpvote} className="px-2 upvote text-red-450 dark:text-black">{modalItem.upvote}</span>
                          <button onClick={handleDownvote.bind(modalItem)} className="pr-2 relative">
